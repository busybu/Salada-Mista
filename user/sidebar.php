      ...
      <div class="sidebar close">
        ...
        <ul class="nav-links">
          <li>
            ...
            <ul class="sub-menu">
              <li><input type="submit" class="link_name" href="../user/home.php" name="Title" value="Proteção"></input></li>
              <li><input type="submit" name="Title" value="IST"></input></li>
              <li><input type="submit" name="Title" value="Contraceptivos"></input></li>
              <li><input type="submit" name="Title" value="Preservativo"></input></li>
            </ul>
          </li>
          <li>
            <div class="iocn-link">
            ...
            <ul class="sub-menu">
              <li><input type="submit" class="link_name" name="Title" value="Fertilidade"></input></li>
              <li><input type="submit" name="Title" value="Gravidez"></input></li>
              <li><input type="submit" name="Title" value="Gestação"></input></li>
            </ul>
          </li>
          <li>
            <div class="iocn-link">
            ...
            <ul class="sub-menu">
              <li><input type="submit" name="Title" value="Ciclo Menstrual" class="link_name"></a></li>
              <li><input type="submit" name="Title" value="Menstruação"></a></li>
            </ul>
          </li>
          <li>
            <div class="iocn-link">
            ...
            <ul class="sub-menu">
              <li><input type="submit" name="Title" value="Anatomia" class="link_name"></a></li>
              <li><input type="submit" name="Title" value="Masculino"></a></li>
              <li><input type="submit" name="Title" value="Feminino"></a></li>
            </ul>
          </li>
          <li>
            <a href="../user/perguntas.php">
