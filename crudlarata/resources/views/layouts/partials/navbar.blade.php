<body>
	<div class="sidebar close">
		...
		<ul class="nav-links">
			<li>
				<div class="iocn-link">
					<a href="/crudlarata/resources/views/home/protecao.php"> <i class=""><img src="/assets/images/icon_1.png"
							class="icon-sidebar"></i> <span class="link_name">Proteção</span>
					</a> <i class='bx bxs-chevron-down arrow'></i>
				</div>
				<ul class="sub-menu">
					<li><a class="link_name" href="/crudlarata/resources/views/home/protecao.php">Proteção</a></li>
			...
			<li>
				<div class="profile-details">
					...
					<div class="name-job">
						<div class="profile_name">Fazer login</div>
						<div class="job"></div>
					</div>
