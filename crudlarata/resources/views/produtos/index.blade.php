...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            ...
            <a href="{{ route('produtos.create') }}" class="btn btn-primary btn-sm float-right">Criar novo</a>
        </div>
            ...
            <tbody>
                @foreach($produtos as $produto)
                    <tr>
                        ...
                        <td><a href="{{ route('produtos.show', $produto->id) }}" class="btn btn-warning btn-sm">Ver</a></td>
                        <td><a href="{{ route('produtos.edit', $produto->id) }}" class="btn btn-info btn-sm">Editar</a></td>
                        <td>
